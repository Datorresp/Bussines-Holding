...
public void showMenu(){
  ...
  while(userImput != 0){
    ...
    if(userImput == 1){
      ...
      if(userSelection == 1){
        ...
        if(userSel == 1){
          ...
          pollss.add(kjr);
          hold.addCompanyWithPolls(m,pollss);
        ...
        if(userSel1 == 1){
          ...
          pollss1.add(kjr1);
          hold.addCompanyWithPolls(n,pollss1);
    ...
    if(userSel2 == 1){
      ...
      pollss2.add(kjr2);
      hold.addCompanyWithPolls(b,pollss2);
      ...
      l1.add(m1);
      hold.addCompanyProducts(lol,l1);
  ...
  System.out.println(hold.getCompanyWithProducts(nombre));
  ...
  for(int j = 0; j < k;j++){
    ...
    if(hold.getProductWithCompany(nombre) != null){
    hold.getProductWithCompany(nombre).add(kl);
  }
}
...
System.out.println(hold.getCompanyWithPolls(nombre1));
...
for(int i = 0; i < 10; i++){
  ...
  if(hold.getPollsWithCompany(nombre1) != null){
    hold.getPollsWithCompany(nombre1).add(kj);
  }
  ...
  for(int h = 0; h < 50;h++){
    ...
    if(hold.getPollsWithCompany(nombre1) != null){
      hold.getPollsWithCompany(nombre1).add(mkj);
  }
}
}
...
hold.addBuildingToCompany(nameCom,willy);
...
hold.addEmployeerToCubicules(comName,nameEm,positionEm,emailEm);
...
System.out.println(hold.showBuildingL(nombreComy,nameEmple));
  ...
  System.out.println(hold.showBuildingE(nombreComy1,nameEmple1));
  ...
  System.out.println(hold.showBuildingEspiral(nombreComy1,cargo1));
  ...
  public void init(){
    ...
    hold = new Holding(new Building(13));
    ...
    ms.add(zk);
    hold.addCompanyProducts(invi,ms);
